...
import { ChevronDown, ExternalLink, MapPin, TrendingUp } from "lucide-react";
        ...
        <section className="py-16 sm:py-24 lg:py-32 bg-background text-foreground overflow-x-hidden">
            <div className="container mx-auto px-4">
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    <div
                        className="relative w-full h-80 sm:h-96 md:h-[500px] lg:h-full rounded-xl overflow-hidden shadow-2xl"
                        data-aos="fade-right"
                    ...
                    >
                        ...
                        <div className="absolute bottom-6 left-6 p-4">
                            <h3 className="text-2xl sm:text-3xl font-bold text-white shadow-sm">
                                Virunga, Terre de Géants
                            </h3>
                            <p className="text-sm sm:text-base text-gray-200 mt-1">
                                Explorez les volcans et les gorilles de montagne.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        <div className="space-y-5 text-lg text-muted-foreground mb-8">
                            <p>
                                La République Démocratique du Congo, un joyau brut au cœur de l&rsquo;Afrique, vous invite à une aventure sans pareille.
                            ...
                            <p>
                                ...
                                attendant d&rsquo;être découverte par les voyageurs audacieux et les investisseurs visionnaires.
                            </p>
                        </div>
                            ...
                            <AccordionItem value="item-1" className="border-b">
                                ...
                                <AccordionContent className="pt-1 pb-4 px-5 text-sm sm:text-base text-muted-foreground space-y-3">
                                    <p>
                                        ...
                                        La RDC est une destination de choix pour l&rsquo;écotourisme et les expériences authentiques.
                                    </p>
                                    <Link href="/circuits-touristiques">
                                        <Button variant="link" className="p-0 h-auto text-primary">
                                            Découvrir nos circuits <ExternalLink className="ml-1 h-4 w-4" />
                                        </Button>
                                    </Link>
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-2" className="border-b-0">
                                ...
                                <AccordionContent className="pt-1 pb-4 px-5 text-sm sm:text-base text-muted-foreground space-y-3">
                                    <p>
                                        ...
                                        un potentiel d&rsquo;investissement considérable dans l&rsquo;agriculture, les énergies renouvelables, les infrastructures et le tourisme.
                                    </p>
                                    <a href="#" target="_blank" rel="noopener noreferrer">
                                        <Button variant="link" className="p-0 h-auto text-primary">
                                            Explorer les secteurs porteurs <ExternalLink className="ml-1 h-4 w-4" />
                                        </Button>
                                    </a>
                                </AccordionContent>
                            </AccordionItem>
