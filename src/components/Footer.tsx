            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-10">
                    ...
                    <div className="space-y-4 md:col-span-2 lg:col-span-1" data-aos="fade-up">
                        ...
                        <p className="text-sm">
                            Votre porte d&rsquo;entrée vers les merveilles de la République Démocratique du Congo.
                    ...
                    <div data-aos="fade-up" data-aos-delay="100">
                        {/* Utiliser 'text-foreground' pour les titres pour qu'ils soient plus prononcés */}
                        <h5 className="font-semibold text-foreground mb-3">Navigation</h5>
                    ...
                    <div data-aos="fade-up" data-aos-delay="300">
                        <h5 className="font-semibold text-foreground mb-3">Restez Informé</h5>
                        <p className="text-sm mb-3">Recevez nos dernières offres et actualités directement dans votre boîte mail.</p>
                        <form className="flex gap-2">
                            {/* Les composants Input/Button de shadcn utilisent déjà les variables par défaut */}
                            <Input type="email" placeholder="Votre email" className="bg-input border-border text-foreground placeholder:text-muted-foreground flex-grow" />
                            {/* Le bouton a déjà un style qui s'adapte, pas besoin de le forcer. */}
